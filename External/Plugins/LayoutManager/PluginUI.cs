...
namespace LayoutManager
{
	public class PluginUI : DockPanelControl
    {
        ...
        private void FormLoaded(Object sender, EventArgs e)
        {
            ...
            String file = Path.Combine(this.GetLayoutsDir(), "DefaultLayout.ldl");
        ...
        private void PopulateLayoutsListView()
        {
            ...
            String[] layouts = Directory.GetFiles(this.GetLayoutsDir(), "*.ldl");
        ...
        private void SaveButtonClick(Object sender, EventArgs e)
        {
            try
            {
                ...
                sfd.DefaultExt = "ldl"; sfd.FileName = "";
        ...
        private void WriteDefaultLayout(String file)
        {
            try
            {
                ...
                Stream src = assembly.GetManifestResourceStream("LayoutManager.Resources.Default.ldl");
