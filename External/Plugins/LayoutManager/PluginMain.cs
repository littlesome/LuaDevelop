...
namespace LayoutManager
{
	public class PluginMain : IPlugin
	{
        ...
        private String pluginHelp = "www.LuaDevelop.org/community/";
        private String pluginDesc = "Adds a panel layout manager to LuaDevelop.";
		...
		public void HandleEvent(Object sender, NotifyEvent e, HandlingPriority prority)
		{
            switch (e.Type)
            {
                case EventType.FileOpening:
                    ...
                    if (te.Value.EndsWith(".ldl") && File.Exists(te.Value))
                    {
                        te.Handled = true;
