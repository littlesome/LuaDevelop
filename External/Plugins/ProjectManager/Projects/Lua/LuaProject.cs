...
namespace ProjectManager.Projects.Lua
{
    ...
    {
        public LuaProject(string path)
            : base(path)
        {
        }

        public override string Language { get { return "lua"; } }
        ...
        public static LuaProject Load(string path)
        {
            LuaProjectReader reader = new LuaProjectReader(path);
            try
            {
        ...
        public override void SaveAs(string fileName)
        {
            ...
            try
            {
                LuaProjectWriter writer = new LuaProjectWriter(this, fileName);
                writer.WriteProject();
                writer.Flush();
                writer.Close();
            }
