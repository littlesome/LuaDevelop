...
namespace ProjectManager.Helpers
{
	...
	public class ProjectCreator
	{
		...
		// copy a file, if it's an .as or .ldp file, replace template keywords
        ...
        {
            projectTypes["project.luaproj"] = typeof(LuaProject);
            projectExt.Add("*.luaproj");
        ...
        public static string GetProjectFilters()
        {
            ...
            string filters = "LuaDevelop Projects|" + String.Join(";", exts);
            return filters;
        }
