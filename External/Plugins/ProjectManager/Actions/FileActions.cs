...
namespace ProjectManager.Actions
{
    ...
    public class FileActions
    {
        ...
        public FileActions(IMainForm mainForm, LuaDevelopActions fdActions)
        {
        ...
        public void Delete(string path, bool confirm)
        {
            ...
            try
            {
                ...
                string caption = " " + TextHelper.GetString("LuaDevelop.Title.ConfirmDialog");
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    {
                        String error = TextHelper.GetString("LuaDevelop.Info.CouldNotBeRecycled");
        ...
        public void Move(string fromPath, string toPath)
        {
            ...
            try
            {
                ...
                if (File.Exists(toPath))
                {
                    ...
                    {
                        String message = TextHelper.GetString("LuaDevelop.Info.CouldNotBeRecycled");
        ...
        private bool ConfirmOverwrite(string path)
        {
            ...
            {
                string title = " " + TextHelper.GetString("LuaDevelop.Title.ConfirmDialog");
