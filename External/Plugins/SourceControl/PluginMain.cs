...
namespace SourceControl
{
	public class PluginMain : IPlugin
	{
        ...
        private String pluginDesc = "Source Control integration for LuaDevelop.";
        ...
        private void CheckPathExists(string path, string name)
        {
            ...
            if (!File.Exists(path))
            {
                string msg = String.Format(TextHelper.GetString("LuaDevelop.Info.InvalidToolPath"), name, "SourceControl") 
                    + ":\n" + path;
