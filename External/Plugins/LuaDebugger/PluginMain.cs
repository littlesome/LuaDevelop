...
using ProjectManager.Projects.Lua;
using PluginCore;
...
namespace LuaDebugger
{
	...
	{
        private String pluginName = "LuaDebugger";
		private String pluginHelp = "http://www.flashdevelop.org/community/";
        private String pluginDesc = "Hosts the ActionScript 3 debugger in LuaDevelop.";
        private String pluginAuth = "LuaDevelop Team";
        ...
        {
            String dataPath = Path.Combine(PathHelper.DataDir, "LuaDebugger");
			if (!Directory.Exists(dataPath)) Directory.CreateDirectory(dataPath);
			this.settingFilename = Path.Combine(dataPath, "Settings.ldb");
