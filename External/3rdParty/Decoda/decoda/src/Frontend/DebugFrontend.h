...
public:
	virtual ~IEvtHandler() {}
	virtual void AddPendingEvent(const DebugEvent& e) = 0;
};
...
public:
     ...
     */
    void SetEventHandler(IEvtHandler* eventHandler);
     ...
     */
    std::string Evaluate(unsigned int vm, const char* expression, unsigned int stackLevel);
