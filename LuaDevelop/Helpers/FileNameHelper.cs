...
namespace LuaDevelop.Helpers
{
    class FileNameHelper
    {
        ...
        public static String SessionData
        {
            get
            {
                return Path.Combine(PathHelper.SettingDir, "SessionData.ldb");
            }
        }
        ...
        public static String LayoutData
        {
            get
            {
                return Path.Combine(PathHelper.SettingDir, "LayoutData.ldl");
            }
        }
        ...
        public static String SettingData
        {
            get
            {
                return Path.Combine(PathHelper.SettingDir, "SettingData.ldb");
            }
        }
        ...
        public static String ShortcutData
        {
            get
            {
                return Path.Combine(PathHelper.SettingDir, "ShortcutData.lda");
            }
        }
        ...
        public static String UserArgData
        {
            get
            {
                return Path.Combine(PathHelper.SettingDir, "UserArgData.lda");
            }
        }
