...
namespace LuaDevelop.Dialogs
{
    public class SnippetDialog : SmartForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.saveFileDialog.DefaultExt = "ldz";
            this.saveFileDialog.Filter = "LuaDevelop Zip Files|*.ldz";
            // 
            // contentsTextBox
            //
        ...
        private void SnippetListViewSelectedIndexChanged(Object sender, EventArgs e)
        {
            ...
            path = Path.Combine(path, name + ".lds");
        ...
        private void DeleteButtonClick(Object sender, EventArgs e)
        {
            ...
            String path = Path.Combine(this.SnippetDir, this.currentSyntax);
            path = Path.Combine(path, this.snippetNameTextBox.Text + ".lds");
        ...
        private void ExportButtonClick(Object sender, EventArgs e)
        {
            if (this.saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                String[] snippetFiles = Directory.GetFiles(this.SnippetDir, "*.lds", SearchOption.AllDirectories);
                zipFile.BeginUpdate();
