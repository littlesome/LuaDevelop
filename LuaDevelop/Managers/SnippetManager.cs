...
namespace LuaDevelop.Managers
{
    class SnippetManager
    {
        ...
        {
            String global = Path.Combine(PathHelper.SnippetDir, word + ".lds");
            String specificDir = Path.Combine(PathHelper.SnippetDir, syntax);
            String specific = Path.Combine(specificDir, word + ".lds");
        ...
        public static Boolean InsertTextByWord(String word, Boolean emptyUndoBuffer)
        {
            ...
            else if (canShowList)
            {
                ...
                PathWalker walker = new PathWalker(PathHelper.SnippetDir, "*.lds", false);
                ...
                {
                    walker = new PathWalker(path, "*.lds", false);
